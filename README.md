# Hyvä PWA for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="300" height="300" src="https://www.jajuma.de/sites/default/files/ckfinder/userfiles/images/jajuma-develop/hyva-pwa-hyva-themes-magento/Hyva-PWA-Magento-2-large.png">  

Hyvä PWA by [JaJuMa](https://www.jajuma.de/en) allows 
...
* [Extension Website EN](https://www.jajuma.de/en/jajuma-develop/extensions/hyva-pwa-extension-for-hyva-themes-magento-2)
* [Extension Website DE](https://www.jajuma.de/de/jajuma-develop/extensions/hyva-pwa-extension-fuer-hyva-themes-magento-2)
...
<img align="left" width="250" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Google_Play_Store_badge_EN.svg/360px-Google_Play_Store_badge_EN.svg.png?20220907104002">
</a>
...
```
composer require jajuma/module-hyva-pwa
```

## Using Hyvä Themes as PWA with JaJuMa "Hyvä PWA" module

Go to **JaJuMa -> Hyvä PWA -> Configuration**  
And complete the configurations for manifest and service worker.

* [See Manual for more details](https://www.jajuma.de/sites/default/files/ckfinder/userfiles/images/jajuma-develop/hyva-pwa-hyva-themes-magento/JaJuMa_Hyva_PWA_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/hyva-pwa/blob/master/LICENSE)
...
* :bell: Marketing:<br>[Customer Registration Reminder & Cleanup for Magento 2](https://www.jajuma.de/en/jajuma-develop/extensions/customer-registration-reminder-and-cleanup-extension-for-magento-2)<br>
  Increase Your Customer Engagement & Cleanup your Customer Account Data Automatically
